...
const WorkTimeline = () => {
  return (
    <div className="w-full border dark:border-neutral-800 border-neutral-200 p-5 sm:p-6 rounded-md">
      {/* Gigbei Experience */}
      <div className="w-full mb-10">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-5 gap-1">
          ...
          <div>
            <Link href={"https://www.gigbei.com/"}>
      ...
      <div className="w-full">
        ...
        <ul className="space-y-3 pl-5 list-disc">
          ...
          <li className="text-neutral-700 dark:text-neutral-300">
            ...
            to various screen sizes, improving accessibility and user experience
            across devices.
          </li>
        </ul>
      </div>
